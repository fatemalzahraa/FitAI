        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IlgiliKayitTipi = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WidgetSorguId = table.Column<int>(type: "int", nullable: true),
                    PlatformSiparisKodu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SatisTutari = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    KomisyonTutari = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    KomisyonOrani = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AIAttributionMi = table.Column<bool>(type: "bit", nullable: false),
                    AttributionTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KomisyonKayitlari", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "KullaniciProfilleri",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CihazId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VucutTipi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Boy = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Kilo = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TercihleriJSON = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KullaniciProfilleri", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MagazaAdi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Eposta = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SifreHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KomisyonOrani = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MinimumKomisyonEsigi = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PaketTuru = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AktifMi = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DuyguSkoru = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DuyguEtiketi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OneriMetni = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NlpBulgulari", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OnboardingAdimlari",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    AdimKodu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnboardingAdimlari", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PlatformBaglantilari",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MagazaId = table.Column<int>(type: "int", nullable: false),
                    PlatformTuru = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApiAnahtari = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AktifMi = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlatformBaglantilari", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SenkronizasyonLoglari",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MagazaId = table.Column<int>(type: "int", nullable: false),
                    SyncTipi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Durum = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SenkronizasyonLoglari", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "VucutUyumSkorlari",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UrunId = table.Column<int>(type: "int", nullable: false),
                    MagazaId = table.Column<int>(type: "int", nullable: false),
                    VucutTipi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UyumSkoru = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IadeRiski = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VucutUyumSkorlari", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "WidgetSorguLoglari",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UrunId = table.Column<int>(type: "int", nullable: false),
                    MagazaId = table.Column<int>(type: "int", nullable: false),
                    DonulenUyumSkoru = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SatinAlmaGerceklesti = table.Column<bool>(type: "bit", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WidgetSorguLoglari", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MagazaId = table.Column<int>(type: "int", nullable: false),
                    KullaniciId = table.Column<int>(type: "int", nullable: true),
                    TalimatMetni = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnlasilanSenaryo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IslenenAgirliklar = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OncekiAgirliklar = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OnayDurumu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EtkiRaporu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EtkiRaporuOlusturulduMu = table.Column<bool>(type: "bit", nullable: false),
                    PlanlananEtkiTarihi = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiTalimatlar", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AiTalimatlar_Kullanicilar_KullaniciId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KesimTuru = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KumasEsnek = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiTalimatlar_KullaniciId",
                table: "AiTalimatlar",
                column: "KullaniciId");
